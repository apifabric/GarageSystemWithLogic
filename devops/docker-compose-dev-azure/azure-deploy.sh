...
resourcename="garagesystemiter1"  # lower case, only
resourcegroup="garagesystemiter1_rg"
...
# git clone https://github.com/apilogicserver/garagesystemiter1.git
# cd garagesystemiter1
...
az group create --name garagesystemiter1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group garagesystemiter1_rg --sku S1 --is-linux
az container create --resource-group garagesystemiter1_rg --name garagesystemiter1 --image apilogicserver/garagesystemiter1:latest --dns-name-label garagesystemiter1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//garagesystemiter1.westus.azurecontainer.io:5656'
